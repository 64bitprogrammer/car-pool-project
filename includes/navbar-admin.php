  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-2" aria-expanded="false" style="height: 1.11667px;">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li <?=$current_page=='users_list'?"class='active'":"";?> ><a href="users_list.php">Users List</a></li>
        <li <?=$current_page=='pricing'?"class='active'":"";?> ><a href="pricing.php">Pricing</a></li>
        <li <?=$current_page=='templates'?"class='active'":"";?> ><a href="templates.php">Email Templates</a></li>
